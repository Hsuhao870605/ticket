...
$sql = "SELECT * FROM expresspasstoamuse WHERE tc2_id={$tc2_id}";
        ...
        <div class="card-body">
          ...
          <form name="form1" onsubmit="return false">
            ...
            <div class="input-group mb-3">
              ...
              <select class="form-select" name="tc2_id" id="cate1" onchange="generateCate2List()">
                <?php foreach ($rows as $r) :
                  if ($r['tc2_id'] == $row['tc2_id']) : ?>
                    <option value="<?= $r['tc2_id'] ?>"<?= ($r['tc2_id'] == $row['tc2_id']) ?>><?= $r['tc2_name'] ?> </option>
                <?php
                  endif;
                endforeach ?>
              </select>
